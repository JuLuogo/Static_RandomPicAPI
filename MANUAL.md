...
**占位符：**
*   `https://random:h` - 横屏随机图
*   `https://random:v` - 竖屏随机图
...
<!-- 链接 -->
<a href="https://random:v" target="_blank">点击查看随机竖屏图</a>
```

#### 2. 样式属性 (style)
```html
<!-- 背景图 -->
<div style="background-image: url('https://random:h'); width: 100%; height: 300px;">
    背景图区域
</div>
```
...
<!-- meta 标签 -->
<meta property="og:image" content="https://random:h">
```

#### 4. 文本内容 (Text Content)
甚至页面上直接显示的文本也会被替换（只要包含该占位符）。
```html
<p>当前的随机图链接是：https://random:v</p>
